...
io.on('connection', socket => {
    ...
    socket.on('enterRoom', ({ name, room }) => {
      ...
      //Cannot update previou room users list ubntil after the state update in activate user
      if (previousRoom) {
      ...
      //To user who joined
      socket.emit('message', buildMsg(ADMIN, `You have just joined the ${user.room} chat room`))
    ...
    socket.on('disconnect', () =>{
      ...
      console.log(`User ${socket.id} has left the app :(`)
    })
